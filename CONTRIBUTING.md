...
2. **Clone the forked repository:**
   ...
   ```bash
   git clone https://github.com/MegrajChauhan/Language.git
   cd website
   ```
...
3. **Set up the upstream remote:**
   ...
   ```bash
   git remote add upstream https://github.com/MegrajChauhan/Language.git
   ```
...
If you encounter any issues, please report them using the [Issue Tracker](https://github.com/MegrajChauhan/Language.git/issues). When reporting an issue, please include:
